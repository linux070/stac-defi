const BackgroundGradient = () => {
    return (
        ...
        <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-gray-50 dark:bg-gray-900">
            ...
            <div className="absolute top-[10%] left-[10%] w-[450px] h-[450px] bg-cyan-400/20 dark:bg-cyan-500/10 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[100px] opacity-40 animate-blob animation-delay-3000" style={{ willChange: 'transform' }}></div>

            {/* --- BOTTOM RIGHT BLOBS (Warm & Deep Tones) --- */}
            {/* Blob 3: Arc Purple (Rich & Immersive) */}
            <div className="absolute bottom-[-10%] right-[-5%] w-[700px] h-[700px] bg-purple-500/30 dark:bg-purple-600/20 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[130px] opacity-60 animate-blob animation-delay-2000" style={{ willChange: 'transform' }}></div>

            {/* Blob 4: Indigo/Violet (Subtle Depth) */}
            <div className="absolute bottom-[20%] right-[10%] w-[500px] h-[500px] bg-indigo-500/20 dark:bg-violet-600/15 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[110px] opacity-50 animate-blob animation-delay-5000" style={{ willChange: 'transform' }}></div>
