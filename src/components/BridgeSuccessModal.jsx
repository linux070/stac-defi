    ...
    return createPortal(
        <AnimatePresence>
            {isOpen && (
                ...
                >
                     <motion.div
                        className="w-full max-w-[440px] max-h-[calc(100dvh-40px)] overflow-y-auto custom-scrollbar bg-white dark:bg-[#121212] rounded-[24px] sm:rounded-[32px] overflow-hidden shadow-[0_32px_80px_-20px_rgba(0,0,0,0.4)] dark:shadow-[0_32px_64px_-12px_rgba(0,0,0,0.8)] border border-slate-200 dark:border-white/10"
